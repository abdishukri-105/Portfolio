...
const portfolios = [
  {
    ...
    title: "Beauty Bliss",
    description:
    " An E-commerce application built with Rails API and React",
  ...
  },
  {
    ...
    description:
      "Rails and react meme generator app for moringa school project ",
  ...
  },
  {
    ...
    title: "Library app",
    description:
      "React application that utilizes google books api",
  ...
  },
  {
    ...
    title: "blog page",
    description:
      "article web application Built with RUBY and React",
