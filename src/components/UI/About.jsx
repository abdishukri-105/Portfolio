              ...
              <div>
                {activeTab === "personal" && (
                  <div className="text-center xl:text-left">
                    <h3 className="text-2xl font-bold md:mb-2 mb-6">
                    ...
                    <div className="grid   xl:grid-cols-2  gap-4 mb-6">
                      {infoData.map((item, index) => (
                        <div
                          key={index}
                          className="flex gap-x-4  mx-aut xl:mx-0"
                        >
                          {/* Render the icon */}
                ...
                {activeTab === "qualifications" && (
                  <div>
                    <h3 className="text-2xl font-bold mb-6 text-headingColor  text-center xl:text-left">
                      My Awesome Journey
                    </h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      ...
                      <div className="flex flex-col gap-6">
                        <div className="flex items-center gap-4 text-primary">
                          <FaBriefcase size={28} />
                          <h4 className="capitalize text-3xl underline text-headingColor font-medium">
                            Experience
                          </h4>
                        </div>
                        {/* experience list */}
                ...
                {activeTab === "skills" && (
                  <div className="text-center xl:text-left">
                    ...
                    {/* Skills */}
                    <div className="mb-4">
                      <h4 className="text-3xl text-left font-semibold mb-2">
                        Skills
                      </h4>
                        ...
                        {skillData
                          ...
                          .data.map((item, index) => (
                            <div className="flex p-1 gap-5 ">
                              ...
                              <div
                                className="w- text-center mb-3 md:mb-1  xl:text-left mx-auto xl:mx-0"
                                key={index}
                              >
