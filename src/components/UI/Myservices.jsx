...
import { FaTape, FaMoneyBillWave } from 'react-icons/fa';
import { SiMaterialdesignicons, SiAffinitydesigner } from "react-icons/si";
                            ...
                            <div className="hidden absolute w-1 sm:block bg-teal-700 h-full left-1/2 transform
                             ...
                             <div className="mt-6 sm:mt-0 sm:mb-12">
                                <div className="flex items-center flex-col sm:flex-row">
                                    ...
                                    {/* <div className="rounded-full bg-teal-500 border-white border-4 w-10 h-10 absolute left-1/2 transform -translate-x-1/2 -translate-y-4 sm:translate-y-0 flex items-center justify-center">
                                        <div className="">
                                            <FaTape className=''/>
                             ...
                             {/* <div className="mt-6 sm:mt-0 sm:mb-12">
                                <div className="flex items-center flex-col sm:flex-row">
                                    ...
                                    <div className="flex justify-start w-full mx-auto items-center">
                                        <div className="w-full sm:w-1/2 sm:pr-8">
                                            <div data-aos='fade-up' data-aos-delay='50'  data-aos-duration='1300' className="bg-white p-4 border border-gray-300  hover:border-accent rounded-[18px] group  cursor-pointer ease-in duration-150">
                                                <h3 className="text-primaryColor font-[700] mb-3  group-hover:font-[600] text-center lg:text-left text-2xl">step 5</h3> 

                                                <p className="text-[15px]   ">
                                                  We then get the right estimates that fit your design and budget and once agreed we can plan starting the project.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
